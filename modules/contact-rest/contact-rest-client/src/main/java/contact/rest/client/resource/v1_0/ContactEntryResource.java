 ...
 */
@Generated("")
public interface ContactEntryResource {
	...
	public HttpInvoker.HttpResponse deleteContactEntryHttpResponse(
			Integer entryId)
		throws Exception;

	public void deleteContactEntryBatch(
			Integer entryId, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteContactEntryBatchHttpResponse(
			Integer entryId, String callbackURL, Object object)
		throws Exception;

	public ContactEntry getContactEntryId(Integer entryId) throws Exception;

	public HttpInvoker.HttpResponse getContactEntryIdHttpResponse(
			Integer entryId)
		throws Exception;
	...
	public static class Builder {
		...
		public ContactEntryResource build() {
			return new ContactEntryResourceImpl(this);
		}
	...
	public static class ContactEntryResourceImpl
		...
		public ContactEntry postContactEntry(ContactEntry contactEntry)
			...
			try {
				return ContactEntrySerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postContactEntryHttpResponse(
			...
			httpInvoker.body(contactEntry.toString(), "application/json");
		...
		public void deleteContactEntry(Integer entryId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteContactEntryHttpResponse(entryId);
		...
		public void deleteContactEntryBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteContactEntryBatchHttpResponse(
		...
		public ContactEntry getContactEntryId(Integer entryId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getContactEntryIdHttpResponse(entryId);
		...
		private ContactEntryResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ContactEntryResource.class.getName());
