...
public class ContactServiceHttp {
	...
	public static java.util.List<com.liferay.contact.management.model.Contact>
			getAllContacts(HttpPrincipal httpPrincipal)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				ContactServiceUtil.class, "getAllContacts",
				_getAllContactsParameterTypes4);
			...
			return (java.util.List
				<com.liferay.contact.management.model.Contact>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				ContactServiceUtil.class, "getEntriesByContactId",
	...
	private static final Class<?>[] _getAllContactsParameterTypes4 =
		new Class[] {};
